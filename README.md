...
🎓 I’m **Jiahao Zhu**, a Computer Science student at **University College Dublin (UCD)** 🇮🇪.  
💡 Passionate about **software engineering, data science and AI**.

- 🔭 Currently working on: **UCDSwap** — a full-stack Java web app
- 🌱 Learning: **Java**, **Algorithm**, **Cloud Deployment (AWS)**
- 🧠 Interested in: **Software Engineering**, **Data Analytics**, **Cloud Computing**

<p align="right">
  <img src="https://komarev.com/ghpvc/?username=Zahotoo&style=flat-square&color=1abc9c" alt="Profile views" />
</p>
...
### Languages and Tools:
<p align="center">
  <img src="https://skillicons.dev/icons?i=c,cpp,java,python,r,spring,html,git,mysql,linux,flutter,maven,raspberrypi,visualstudio,vscode&theme=dark" />
</p>
...
|----------------------------------|---------------------------------------------------------------------------|--------------------------------|
| 🛒 **UCDSwap**                   | A campus item exchange platform built with Java Spring Boot               | Spring Boot, MySQL, Maven      |
| 🛰️ **NASA SpaceApps Challenge** | A real-time weather and climate data app developed for the NASA Hackathon | Flutter, Dart, OpenWeather API |

📍 Explore more projects on my [**Repositories**](https://github.com/Zahotoo?tab=repositories)!
...
<p align="center">
  ...
  <img width="48%" src="https://github-readme-streak-stats.herokuapp.com/?user=Zahotoo&theme=tokyonight" />
</p>
